...
function getZohoTasksForProject(zohoProjectId, zohoProjectName) {
  ...
  if(currentTask) {
    ...
    $.getJSON( zohoBaseUrl+"projects/"+zohoProjectId+"/tasks/", { authtoken: "bf97913da8a83b9bbccaa87e66242727", owner: "20062563695", status: "all", time: "all", priority: "all" }, function( data ) {
      // Always cache the response to prevent further API calls, but only go on if there was data.
